  ...
  return (
    <main className="w-scr een min-h-screen py-[65px]">
      <div className="mx-auto px-4 transition-all tablet-md:max-w-[1320px] tablet-md:px-12">
        ...
        <div>
          Your privacy is important to us. It is tuniko.info&apos;s policy to
          respect your privacy regarding any information we may collect from you
          across our website, https://tuniko.info, and other sites we own and
          operate.
          <br />
          <br />
          ...
          regard to the personal data processed through habitsgarden.com and the
