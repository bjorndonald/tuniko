        ...
        {entryType === "Document" && (
          <>
            <button
              ...
              className={`flex h-9 items-center gap-1.5 border border-[rgb(218,220,224)] pl-[11px] pr-[15px] transition hover:bg-primary/10 ${entryType === "Document" ? "!bg-primary/10" : ""} rounded cursor-pointer`}
            >
