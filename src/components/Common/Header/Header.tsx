...
const Header = ({ session }: Props) => {
  return (
    <header className="fixed left-0 top-0 w-screen border-b border-b-black/[0.12] py-2 pl-2 pr-4">
      <div className="flex h-12 items-center justify-between">
        ...
        <div className="flex items-center">
          <button className="btn btn-outline btn-primary mr-2 flex hover:text-white">
            <Download width={20} />
            Download CSV
          </button>
